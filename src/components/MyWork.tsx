...
const MyWork = () => {
  ...
  { id: 7, url: 'https://youtu.be/Fo2sbWiUK5g?si=siMcG6mbEZVhnNOd', thumbnail: '', title: 'Crime Awaz India' },
  { id: 8, url: 'https://youtu.be/UwMdox8ZcSw?si=z2mhNoUOhZUgd4IF', thumbnail: '', title: 'Crime Awaz India' },
  { id: 9, url: 'https://youtu.be/Fo2sbWiUK5g?si=siMcG6mbEZVhnNOd', thumbnail: '', title: 'Crime Awaz India' },
];
